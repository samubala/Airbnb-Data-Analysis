...
st.set_page_config(page_title="Airbnb Data Visualization |SAMUNDEESWARI BALA",
                   page_icon=icon,
                   layout="wide",
...
client = pymongo.MongoClient("mongodb+srv://Samundeeswari:Samubala02@cluster0.suhyqtb.mongodb.net/?retryWrites=true&w=majority")
...
if selected == "Home":
    # Title
    st.markdown("## :blue[air bnb data analysis]")
    ...
    col2.image("home.jpg")
    col2.image("analysis.jpg")
    col2.image("airbnb home.png")
    col2.markdown("#   ")
